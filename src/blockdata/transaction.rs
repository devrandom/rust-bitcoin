...
impl Transaction {
    ...
    pub fn encode_signing_data_to<W: Write, U: Into<u32>>(
        &self,
        mut writer: W,
        input_index: usize,
...
#[cfg(test)]
mod tests {
    use super::{Vec, OutPoint, ParseOutPointError, Transaction, TxIn, NonStandardSigHashType};
